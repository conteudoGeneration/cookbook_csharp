...
Vamos analisar o código acima:
 ...
 <div align="left"><img src="https://i.imgur.com/LpZcjnh.png" title="source: imgur.com" /></div>
...
<div align="left"><img src="https://i.imgur.com/wHTDfQ2.png" title="source: imgur.com" width="4%"/> <a href="https://learn.microsoft.com/pt-br/dotnet/api/microsoft.aspnetcore.builder.authappbuilderextensions.useauthentication?view=aspnetcore-7.0" target="_blank"><b>Documentação: Método UseAuthentication</b></a></div>
...
<div align="center"><img src="https://i.imgur.com/9vBrckc.png" title="source: imgur.com" /></div>
...
**Linha 95:** Foi inserida a anotação **[HttpPost]**, que indica que este endpoint será do tipo **POST**. Caso contrário, a sua aplicação não conseguirá receber através do Corpo da Requisição o Objeto da Classe **UserLogin**, contendo o usuario e a senha para autenticar na aplicação. Importante reforçar que no processo de autenticação nenhum dado será persistido no Banco de dados.

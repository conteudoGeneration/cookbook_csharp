...
O **HTTP** utiliza por padrão a **porta 8080** (Localmente, ou seja, no seu Computador) e a **porta 80** (Internet). No ASP.NET utilizaremos a porta 5000.

<div align="center"><img src="https://i.imgur.com/wf8aJPR.png" title="source: imgur.com" /></div>

No Exemplo acima, se um pacote estiver direcionado para a porta 5000, o TCP irá redirecionar o pacote para a nossa aplicação ASP.NET. Se o Pacote, por exemplo, estivesse direcionado para a porta 1433, o TCP redirecionaria o pacote para o nosso Banco de dados SQL Server.
...
<img width="30px" src="https://i.imgur.com/GRJv2YV.png" title="source: imgur.com" />  Assista ao vídeo *Warriors of the NET - IP for Peace* no link: <a href="https://youtu.be/Iqcp3k8DgGw" target="_blank">https://youtu.be/Iqcp3k8DgGw</a>

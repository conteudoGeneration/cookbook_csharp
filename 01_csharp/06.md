...
<div align="left"><img src="https://i.imgur.com/DNV9Rxu.png" title="source: imgur.com" width="30px"/> <a href="https://learn.microsoft.com/pt-br/dotnet/csharp/language-reference/operators/conditional-operator" target="_blank"><b>Documentação: Operador If Ternário</b></a></div>
...
7. Para criar If-Else simples, uma outra alternativa é utilizar o **Operador If Ternário**, que é uma simplificação do If-Else.

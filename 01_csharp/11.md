...
<div align="left"><img src="https://i.imgur.com/JACNZiR.png" title="source: imgur.com" width="25px"/> <a href="" target="_blank"><b>Código fonte</b></a>
...
<h2>2. Separando Classes em Pastas</h2>
...
Em C#, a solução para esses problemas está na organização das classes em **Pastas**, que funcionam de forma semelhante aos **pacotes** no Java. Usualmente, são colocadas em uma **Pasta** todas as classes relacionadas, construídas com um propósito comum para promover a reutilização de código. Na imagem abaixo, vemos o projeto Calculadora estruturado em Pastas:

<div align="center"><img src="https://i.imgur.com/6leuVBP.png" title="source: imgur.com" /></div>

*Na pasta Calculo, temos uma Classe, chamada Calculadora, onde foram implementados os Métodos da calculadora. Observe que a pasta do projeto segue o padrão de escrita das Classes (primeira letra maiúscula) e geralmente não são utilizadas palavras compostas.
...
👉 Observe no código acima, que a **Classe Calculadora** foi importada (**using aula_metodos.Calculo;**), porque ela se encontra em outra pasta (**Calculo**). Para executar os Métodos **Somar(), Subtrair(), Multiplicar() e Dividir()**, foi necessário indicar o nome da Classe. **Exemplo:** `Calculadora.Somar(numero1, numero2);`

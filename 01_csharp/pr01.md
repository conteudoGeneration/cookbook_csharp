...
6. Vamos criar o projeto na **Área de Trabalho do seu Computador** na pasta **csharp**. Abra a pasta **csharp** e clique no botão **Selecionar pasta**.
...
9. Será aberta a janela abaixo, com um Hello World na Classe Program:
...
<h2>👣 Passo 03 - Criar o Menu na Classe Program</h2>

Vamos implementar o código do Menu - versão monocromática (sem as cores) na  **Classe Program**. Vamos analisar o código abaixo:

 <div align="left"><img src="https://i.imgur.com/XlTRsXg.png" title="source: imgur.com" /></div>
...
Execute o projeto clicando no botão <img src="https://i.imgur.com/aVdRIDA.png" title="source: imgur.com" width="4%"/>**Run**. 

...
| <img src="https://i.imgur.com/oScAYGc.png" title="source: imgur.com" width="80px"/> | <div align="left"> **ATENÇÃO:** *Antes de continuar, certifique-se de ter efetuado a instalação do Visual Studio 2022 - Community Edition e do SDK do .NET Core 7.0. Em caso de dúvidas, consulte os <a href="../00_ambiente/README.MD">Guias de Instalação</a> de ambas as ferramentas.* </div> |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
...
6. `<ImplicitUsings>`: É a propriedade que força o compilador a adicionar automaticamente um conjunto de diretivas (importações), com base no tipo de projeto, independente de serem utilizadas ou não. Para aplicativos de console, as seguintes diretivas são incluídas implicitamente no aplicativo:
   - `using System;`
   - `using System.IO;`
...
<div align="center"><img src="Print do código" title="source: imgur.com" /></div>

<br />

**Linha 01:** Foi criado o **namespace helloworld**.

>Um **namespace** é uma maneira de manter um conjunto de Classes e/ou Interfaces separadas de outro.
...
13. Para executarmos o Projeto, clique no botão <img src="https://i.imgur.com/t28CIT4.png" title="source: imgur.com" width="4%"/>**Run**, na **Barra de Ferramentas** (indicado em vermelho na imagem):

...
3. **Herança Simples:** Cada classe pode ter apenas uma superclasse. Na linguagem C# usa-se a palavra reservada **extends** para declarar que uma classe é herdeira de outra.

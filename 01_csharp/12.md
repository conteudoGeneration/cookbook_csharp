...
Um conceito importante, que interfere diretamente no conceito de visibilidade, é o conceito de **Namespace**, visto em <a href="11.md">**Métodos**</a>. Caso você tenha alguma dúvida, acesse o conteúdo.
...
| **public**      | Uma Classe public poderá ser acessada por qualquer classe em qualquer Assembly. |
...
| **public**      | Um Método ou Atributo public poderá ser acessado por qualquer Classe em qualquer Assembly, independente do Namespace. O acesso a um método só é permitido se você tiver primeiro acesso à classe. |  +   |
| **protected**   | Um Método ou Atributo protected o acesso é limitado à classe onde foram criados e as suas subclasses (herança). |  #   |

...
| **override** | O modificador override simplesmente diz que o método que ele segue está sobrescrevendo outro, ou seja, você está apagando o método antigo e colocando no lugar este método novo. |
| **virtual**  | O modificador virtual diz que um método não tem estado definido até que seja executado, ou seja, é "virtual". Geralmente utilizamos este modificador para indicar que um Método poderá ser sobrecarregado na Sub Classe. |

Na tabela acima, destacamos os principais modificadores Non-Access da Linguagem C#. 

**Observações importantes:**

- Um método nunca poderá ser abstract, sealed e final
